...
<section class="add__post">
	...
	<form class="add__post__form" action="index.php?page=post&action=update" method="post" enctype="multipart/form-data">
		<div class="form-group">
			...
			<textarea class="form-control" id="add__content_textarea" name="content" rows="10" cols="80" placeholder="<?= $datas->content ?>"></textarea>
		</div>
