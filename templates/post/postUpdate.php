		...
		<form action="index.php?page=post&action=update" method="post" enctype="multipart/form-data">
			<div class="form__group">
				...
				<div class="input__container img">
					...
					<label for="image">
						<input type="file" class="update__picture__input" id="post_picture" name="post_picture" accept=".jpeg, .jpg, .png, gif">
					</label>
				</div>
				<div class="input__container">
			...
			<div class="update__validation__area">
				...
				<button type="reset" class="cancel__button">Cancel</button>
			</div>
		</form>
	</div>
