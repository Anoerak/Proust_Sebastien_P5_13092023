				...
				<div class="comment__validation">
					...
					<?php if (isset($_SESSION['logged_user']) && $_SESSION['privileges']['privilege'] === 'admin') : ?>
						<div class="comment__actions">
							<button class="main__button" onclick="window.location.href='index.php?page=post&action=validate&option=comment&id=<?= $comment->id ?>&post_id=<?= $_GET['id'] ?>'" <?php if ($comment->validation_status === 'true') : ?>disabled<?php endif; ?>>Publish</button>
