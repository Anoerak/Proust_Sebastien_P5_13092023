<section class="user__profile__container">
	...
	<div class="main__container">
		<div class="left__container">
			<form id="form1"
				action="index.php?page=userProfile&action=update&option=user&id=<?= $_SESSION['user_id'] ?>"
				...
				<div class="action__container">
					<input formnovalidate form="form1" class="main__button update__user" type="submit" value="Update"
						onclick="<?php
		...
		<div class="right__container">
			...
			<form id="form2"
				...
				<div class="input__container">
					...
					<input type="text" name="birthday" id="birthday" onfocus="(this.type='date')" placeholder=" "
						required>
				...
				<div class="user__profile__container__content__newsletter">
					<div class="newsletter__container">
						<form action="index.php?page=newsletter&action=subscribe" method="post">
							...
							<input class="main__button" type="submit" value="Subscribe"
