...
--
-- Host: localhost:8889
-- Generation Time: Oct 01, 2023 at 12:14 PM
...
(29, 25, 20, 'A first comment by myself!!', '2023-09-18 16:26:34', '2023-09-26 19:44:01', 'published'),
...
(14, 20, 'admin', '$2y$10$dKG4Z4avPuvxeg70.1okjetzzlimnnB0oKhueOwRUva9zfT37ktD6'),
(35, 42, 'user', '$2y$10$9p5cpn5mNKp6Ni1S8v/7ROgaCYY63wJi4OK8EAeeycWCVxlWhfUSC');
...
(13, 'user@user.me', 'active'),
(14, 'seb@seb.fr', 'active'),
(35, 'david@jon.fr', 'inactive'),
(37, 'daemon@hell.se', 'active'),
(38, 'user@user.dev', 'active');
...
(43, 20, 'Backend', 'Llama-gpt', 'A self-hosted, offline, ChatGPT-like chatbot, powered by Llama 2. 100% private, with no data leaving your device. #', './public/img/post_picture/651956918a7261.08559695.png', 'Directly integrated on my website https://iamseb.dev, you can ask my offline sefl-hosted GPT bot anything and it will provide you with an answer.<br /><br />\r\nAs it requires a lot of ressources, give it a bit of time (between 20/30 seconds) to get your answer :)', 'gpt, llama, bot, self-hosted, offline, ai', 'https://iamseb.dev#me-anchor', 'https://github.com/Anoerak/llama-gpt', '2023-10-01 11:22:57', NULL);
...
(20, 'admin', 'Sébastien', 'P.', 'seb@iamseb.dev', '1985-01-28', './public/img/profile_picture/650d615993ed68.14760545.webp', '2023-09-18 17:21:40', NULL),
(42, 'user', NULL, NULL, 'user@user.dev', '1970-01-01', './public/img/profile_picture/651961ec87dd86.04014331.jpg', '2023-10-01 14:10:51', NULL);
